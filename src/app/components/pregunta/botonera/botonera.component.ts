  ...
  siguiente() {
    switch (this.btnString) {
      case 'Aceptar': {
        ...
        if (
          this._preguntaService.preguntas.length - 1 ===
      ...
      case 'Siguiente': {
        this._preguntaService.indexPregunta++;
        this._preguntaService.respustasUsuario.push(
          this._preguntaService.indexRespuesta
        );
        this._preguntaService.deshabilitado = true;
